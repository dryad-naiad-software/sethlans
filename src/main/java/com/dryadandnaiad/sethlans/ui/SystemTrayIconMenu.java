...
public class SystemTrayIconMenu implements ActionListener {
    private static SystemTrayIconMenu instance = new SystemTrayIconMenu();
    ...
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(SystemTrayIconMenu.class);

    private SystemTrayIconMenu() {
        sethlansImage = SethlansUtils.createIcon("sethlans_systray.png").getImage();
        trayIcon = new TrayIcon(sethlansImage, "sethlans");
    ...
    public static SystemTrayIconMenu getInstance(){
        return instance;
    }
