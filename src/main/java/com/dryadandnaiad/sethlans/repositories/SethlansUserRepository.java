...
public interface SethlansUserRepository extends JpaRepository<SethlansUser, Long> {
    ...
    Integer countSethlansUsersByRolesEquals(Role role);

    List<SethlansUser> findSethlansUsersByRolesIsNot(Role role);

    boolean existsSethlansUserByUsername(String username);
}
