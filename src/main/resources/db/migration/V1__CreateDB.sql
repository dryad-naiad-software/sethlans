...
by
    ...
    version bigint,
    benchmark_dir varchar(255),
    benchmark_file varchar(255),
    benchmarkurl varchar(255),
    benchmark_uuid varchar(255),
    blender_executable varchar(255),
    blender_version varchar(255),
    complete boolean not null,
    compute_type integer,
    connection_uuid varchar(255),
    cpu_rating integer not null,
...
by
    ...
    blender_version varchar(255),
    current_frame_thumbnail varchar(255),
    current_percentage integer not null,
    end_frame integer not null,
    frame_rate varchar(255),
    movie_file_location varchar(255),
    parts_per_frame integer not null,
    project_end bigint,
    project_name varchar(255),
    project_root_dir varchar(255),
    project_start bigint,
    ...
    remaining_queue_size integer not null,
    render_on integer,
    render_output_format integer,
    res_percentage integer not null,
    resolutionx integer not null,
    resolutiony integer not null,
    samples integer not null,
    start_frame integer not null,
    step_frame integer not null,
    total_project_time bigint,
    total_queue_size integer not null,
    ...
    part_filename varchar(255),
    part_number integer not null,
    part_position_maxy double,
...
by
    ...
    complete boolean not null,
    connection_uuid varchar(255),
    gpu_device_id varchar(255),
    paused boolean not null,
    project_index integer not null,
    project_name varchar(255),
    project_uuid varchar(255),
    queue_item_uuid varchar(255),
...
by
    ...
    deviceid varchar(255),
    in_progress boolean not null,
    part_res_percentage integer not null,
    project_name varchar(255),
    project_uuid varchar(255),
    render_dir varchar(255),
    render_output_format integer,
    render_time bigint,
    samples integer not null,
    server_queue_uuid varchar(255),
...
by
    ...
    allgpuslot_in_use boolean not null,
    available_rendering_slots integer not null,
    benchmark_complete boolean not null,
    combined boolean not null,
    compute_type integer,
    connection_uuid varchar(255),
    cpu_rating integer not null,
    cpu_slot_in_use boolean not null,
    arch varchar(255),
    ...
    pending_activation boolean not null,
    selected_cores varchar(255),
...
by
    ...
    alter table blender_project_frame_part_list add constraint FK55otfpbtkg0a8x0o4ia1jm2sv foreign key (blender_project_id) references blender_project;
